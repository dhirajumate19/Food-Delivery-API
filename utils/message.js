const messages = {
  ...
  invalidFirstName:
    "First name must contain only characters. Symbols and numbers not allowed",
  ...
  invalidLastName:
    "Last name must contain only characters. Symbols and numbers not allowed",
  emptyPhone: "Phone number is required",
  minPhone: "Phone number length must be 12",
  maxPhone: "Phone number length must be 12",
  invalidPhone:
    "Phone number must include the country code. For example: +250731110731",
  ...
  signupConflict:
    "Phone number already registered. Please login or create a new account",
  ...
  orderEmpty:
    "Your order must contain at least one item with itemId, itemName, cost, and quantity",
  ...
  invalidItemQuantity:
    "Item quantity must be a positive number greater or equal to 1",
  ...
  orderUpdateInvalidStatus:
    "Status must be one of [accepted, onthemove, completed]",
  ...
  userNameExisted: "Please Check Your UserName. Its ALready Existed",
